...
public class CreateLoanController {
    ...
    private void handleSave() {
        ...
        try {
            ...
            if (!bookRepository.loanBook(isbn)) {
                showAlert(Alert.AlertType.ERROR, "Erro ao Emprestar", "Não há cópias disponíveis para o livro com ISBN: " + isbn);
                return;
            } else if (repository.saveLoan(loan)) {
